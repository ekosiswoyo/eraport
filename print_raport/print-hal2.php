...
<body onload="window.print()">
    ...
    <table style='font-size:15px' width='100%'>
        ...
        <tr><td>2.</td>  <td width='190px'>Nomor Induk Siswa</td>                          <td width='10px'> : </td><td> <?php echo "$s[nis]"; ?></td></tr>
        ...
        <tr><td>8.</td>  <td width='190px'>Nomor Telepon Rumah</td>                       <td width='10px'> : </td><td> <?php echo "$s[telepon]"; ?></td></tr>
        <tr><td>10.</td> <td width='190px'>Diterima di sekolah ini</td>                   <td width='10px'> : </td><td> <?php echo ""; ?></td></tr>
        ...
        <tr><td>11.</td> <td width='190px'>Orang Tua</td>                                 <td width='10px'> : </td><td> <?php echo ""; ?></td></tr>
        <tr><td></td> <td width='190px'>a. Nama Ayah</td>                                 <td width='10px'> : </td><td> <?php echo "$s[nama_ayah]"; ?></td></tr>
         <tr><td></td> <td width='190px'>b. Nomor Telepon Ayah</td>                          <td width='10px'> : </td><td> <?php echo "$s[no_telpon_ayah]"; ?></td></tr>
        <tr><td></td> <td width='190px'>c. Nama Ibu</td>                                  <td width='10px'> : </td><td> <?php echo "$s[nama_ibu]"; ?></td></tr>
         <tr><td></td> <td width='190px'>d. Nomor Telepon Ibu</td>                          <td width='10px'> : </td><td> <?php echo "$s[no_telpon_ibu]"; ?></td></tr>
        <tr><td></td> <td width='190px'>e. Alamat</td>                                    <td width='10px'> : </td><td> <?php echo "$s[alamat]"; ?></td></tr>
       
                                          
        <tr><td>12.</td> <td width='190px'>Wali Peserta Didik</td>                        <td width='10px'> : </td><td> <?php echo ""; ?></td></tr>
        <tr><td></td> <td width='190px'>a. Nama Wali</td>                                 <td width='10px'> : </td><td> <?php echo "$s[nama_wali]"; ?></td></tr>
       
    </table>
<br><br><br>
    <img src="../files/<?php echo $s[foto];?>" style="width:150px;height:200px;">
    <br><br><br>
    <table width='40%' style='float:right'>
        <tr><td>Pekalongan, <?php echo tgl_raport(date('Y-m-d')); ?> <br>
