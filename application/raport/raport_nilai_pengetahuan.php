<?php 
    if (isset($_POST[simpan])){
            if ($_POST[status]=='Update'){
              mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE rb_nilai_pengetahuan SET kd='$_POST[a]', nilai1='$_POST[b]', nilai2='$_POST[c]', nilai3='$_POST[d]', nilai4='$_POST[e]', nilai5='$_POST[f]', deskripsi='$_POST[g]' where id_nilai_pengetahuan='$_POST[id]'");
            }else{
              mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO rb_nilai_pengetahuan VALUES('','$_GET[jdwl]','$_POST[nis]','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_SESSION[id]','".date('Y-m-d H:i:s')."')");
            }
                                  ...
                                  if ($_GET[nis]==$r[nis]){
                                    echo "<form action='index.php?view=raport&act=listsiswa&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]' method='POST'>
                                      <tr>
                                        ...
                                        <td align=center>
                                        <select name='a' style='width:35px; text-align:center; padding:0px'>
