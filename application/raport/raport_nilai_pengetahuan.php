<?php 
    if (isset($_POST[simpan])){
            if ($_POST[status]=='Update'){
              ...
              mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO rb_nilai_pengetahuan VALUES('','$_GET[jdwl]','$_POST[nisn]','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[g]','$_SESSION[id]','".date('Y-m-d H:i:s')."')");
            }
              ...
              <table class='table table-bordered table-striped'>
                              ...
                              while($r=mysqli_fetch_array($tampil)){
                                  ...
                                  if ($_GET[nisn]==$r[nisn]){
                                    ...
                                    $pe = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM rb_nilai_pengetahuan where kodejdwl='$_GET[jdwl]' AND nisn='$r[nisn]'");
                                    ...
                                    if ($cekpredikat >= 1){
                                      ...
                                      $maxn = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT ((nilai1+nilai2+nilai3+nilai4)/4) as rata_rata, deskripsi FROM rb_nilai_pengetahuan where kodejdwl='$_GET[jdwl]' AND nisn='$r[nisn]' ORDER BY rata_rata DESC LIMIT 1"));
                                      ...
                                      $rapn = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT sum((nilai1+nilai2+nilai3+nilai4)/4)/count(nisn) as raport FROM rb_nilai_pengetahuan where kodejdwl='$_GET[jdwl]' AND nisn='$r[nisn]'"));
