              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    ...
                    <input type="hidden" name='act' value='nilaiutskepsek'>
                  ...
                  <?php
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              echo "<td style='width:70px !important'><center>
                                          <a class='btn btn-success btn-xs' title='Lihat Siswa' href='index.php?view=raportuts&act=listsiswauts&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-th-list'></span> Lihat Nilai</a>
                                        </center></td>";
                              }
