              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    ...
                    <input type="hidden" name='act' value='detailnilaisiswa'>
                      ...
                      $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran,  c.nama_guru FROM rb_jadwal_pelajaran a 
                                            JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                              JOIN rb_guru c ON a.nip=c.nip 
                                                  ...
                                                  where a.kode_kelas='$_SESSION[kode_kelas]' AND e.kode_kelas='$_SESSION[kode_kelas]'
                                                    AND a.id_tahun_akademik='$_GET[tahun]' GROUP BY b.kode_pelajaran ORDER BY a.hari DESC");
                      ...
                      $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran,  c.nama_guru FROM rb_jadwal_pelajaran a 
                                            JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                              JOIN rb_guru c ON a.nip=c.nip 
                                                  JOIN rb_kelas e ON a.kode_kelas=e.kode_kelas 
                                                  where a.kode_kelas='$_SESSION[kode_kelas]' AND e.kode_kelas='$_SESSION[kode_kelas]'
                                                    AND a.id_tahun_akademik LIKE '".date('Y')."%' GROUP BY b.kode_pelajaran ORDER BY a.hari DESC");
                    }
                    $no = 1;
