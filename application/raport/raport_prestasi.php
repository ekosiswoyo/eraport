...
if ($_GET[act]==''){ 
    if (isset($_POST[simpan])){
            if ($_POST[status]=='Update'){
              ...
              mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO rb_nilai_prestasi VALUES('','$_GET[tahun]','$_POST[nisn]','$_GET[kelas]','$_POST[a]','$_POST[b]','$_SESSION[id]','".date('Y-m-d H:i:s')."')");
            }
                ...
                <?php 
                  ...
                  if ($_GET[nisn]==$r[nisn]){   
                    ...
                    echo "<form action='index.php?view=prestasi&tahun=$_GET[tahun]&kelas=$_GET[kelas]' method='POST'>
                            ...
                            $pe = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM rb_nilai_prestasi where id_tahun_akademik='$_GET[tahun]' AND nisn='$r[nisn]' AND kode_kelas='$_GET[kelas]'");
