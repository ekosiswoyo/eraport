              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    <input type="hidden" name='view' value='utssiswa'>
                              ...
                              if (isset($_GET[tahun]) AND isset($_GET[kelas])){
                                if($_SESSION[level]!='kepala'){
                                  echo "<td style='width:70px !important'><center>
                                          <a class='fa fa-fw fa-search' title='Input Nilai Siswa' href='index.php?view=utssiswa&act=listsiswa&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&tahun=$_GET[tahun]'></a>
                                        </center></td>";
                                }
                              }
                            echo "</tr>";
...
cek_session_guru();
    if (isset($_POST[simpan])){
        ...
        echo "<script>document.location='index.php?view=utssiswa&act=listsiswa&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]';</script>";
    }
