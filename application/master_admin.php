              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM rb_users where level='superuser' ORDER BY id_user DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM rb_users where id_user='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
      ...
      if (trim($_POST[b])==''){
        mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE rb_users SET username = '$_POST[a]',
    ...
    if (isset($_POST[add])){
      $data = md5($_POST[b]);
      $passs=hash("sha512",$data);
      mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO rb_users VALUES('','$_POST[a]','$passs','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','superuser','Y')");
      echo "<script>document.location='index.php?view=admin';</script>";
    }
